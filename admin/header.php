        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="index.php"><i class="glyphicon glyphicon-home">Dashboard</i></a></li>
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="buttom" 
                        aria-haspopup="true" aria-expanded="false"><i glyphicon glyphicon-wrench>
                        </i>Pengaturan<span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="harga.php"><i class="glyphicon glyphicon-usd"></i>Pengaturan Harga</a></li>
                        <li><a href="ganti_passwowrd.php"><i class="glyphicon glyphicon-lock"></i>Ganti Password</a></li>
                    </ul>
                    </li>
